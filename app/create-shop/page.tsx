  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (user) {
      const data = {
        ...
        avatar: `https://api.dicebear.com/9.x/pixel-art/svg?seed=${user?.username}` || "",
        userId: user?.id,
      };
      await axios
      ...
      <div>
        ...
        >
          ...
          <div className="w-full my-5">
            ...
            <br />
            <Button
              className="mb-3 w-full bg-transparent h-[45px] border border-primary text-primary hover:bg-primary hover:text-black duration-300 transition-opacity font-Inter font-[600]"
              type="submit"
              disabled={loading}
